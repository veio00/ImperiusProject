...
(function(e,t,n){"use strict";var r,i,s,o,u,a,f,l,c,h,p,d,v,m,g,y,b,w,E,S,x;
S={
	paneClass:"pane",
	sliderClass:"slider",
	...
	y="scrollbar",g="scroll",l="mousedown",c="mousemove",p="mousewheel",h="mouseup",m="resize",u="drag",w="up",v="panedown",s="DOMMouseScroll",o="down",E="wheel",a="keydown",f="keyup",b="touchmove",
	...
	i=null,x=function(){
		...
		n.body.removeChild(e),r},
		d=function(){
			function a(r,s){
				this.el=r,this.options=s,
				i||(i=x()),
				this.$el=e(this.el),
				...
				return a.prototype.preventScrolling=function(e,t){
					...
					else if(e.type===p){if(!e.originalEvent||!e.originalEvent.wheelDelta)return;
